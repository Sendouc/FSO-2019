...
test('dummy returns one', () => {
  ...
  const result = listHelper.dummy(someList)
...
describe('favorite blog', () => {
    ...
    test('correct blog found when there are multiple with the same likes', () => {
        const blogObjectWithMostLikes = listHelper.favoriteBlog(twoBlogsWithSameLikes)
        expect(blogObjectWithMostLikes.likes).toBe(7)
    })
})
